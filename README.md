...
client = StripeMinimal(
    api_key=os.environ.get("STRIPE_MINIMAL_API_KEY"),  # This is the default and can be omitted
)
...
to add `STRIPE_MINIMAL_API_KEY="My API Key"` to your `.env` file
