...
class CardChecks(BaseModel):
    address_line1_check: Optional[Literal["fail", "pass", "unavailable", "unchecked"]] = None

    address_postal_code_check: Optional[Literal["fail", "pass", "unavailable", "unchecked"]] = None

    cvc_check: Optional[Literal["fail", "pass", "unavailable", "unchecked"]] = None


class CardInstallmentsPlan(BaseModel):
...
class CardInstallments(BaseModel):
    plan: Optional[CardInstallmentsPlan] = None
...
class CardThreeDSecure(BaseModel):
    ...
    version: Optional[Literal["1.0.2", "2.1.0", "2.2.0"]] = None
...
class Card(BaseModel):
    ...
    stored_credential_usage: Optional[Literal["recurring", "unscheduled"]] = None
    """
...
from .payment_method_details_payment_record_us_bank_account import PaymentMethodDetailsPaymentRecordUsBankAccount
