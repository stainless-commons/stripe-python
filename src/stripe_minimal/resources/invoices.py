...
class InvoicesResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        custom_fields: Union[Iterable[invoice_create_params.CustomFieldsUnionMember0], Literal[""]] | Omit = omit,
        ...
        discounts: Union[Iterable[invoice_create_params.DiscountsUnionMember0], Literal[""]] | Omit = omit,
