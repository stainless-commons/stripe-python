...
__all__ = ["PaymentIntentListParams", "Created", "CreatedRangeQuerySpecs"]


class PaymentIntentListParams(TypedDict, total=False):
    created: Created
    """A filter on the list, based on the object `created` field.

    The value can be a string with an integer Unix timestamp or a dictionary with a
